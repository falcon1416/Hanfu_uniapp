			...
			<view class="swiper-box">
				<swiper circular="true" autoplay="true" @change="swiperChange">
					<swiper-item v-for="swiper in swiperList" :key="swiper.id" >
						<image src="/static/img/opacity.png" @tap="toSwiper(swiper)" :style="'background:url('+swiper.img+') center/cover no-repeat;'"></image>
					</swiper-item>
				</swiper>
...
export default {
	data() {
		return {
			...
			// 轮播图片
			swiperList: [
				{ id: 1, src: 'url1', img: 'http://sinastorage.com/storage.miaosha.sina.com.cn/products/201805/fce2e2b2bae894cad620992dce0527df.jpeg' },
				{ id: 2, src: 'url2', img: 'http://bbs-fd.zol-img.com.cn/t_s1200x5000/g2/M00/08/05/ChMlWlyxyMqIAH-EAA6KzVZe4qsAAJbPwKRqmMADorl618.jpg' },
				{ id: 3, src: 'url3', img: 'http://b-ssl.duitang.com/uploads/item/201210/03/20121003172032_TzMZQ.jpeg' }
			],
			// 分类菜单
			categoryList: [
				{ id: 1, name: '汉服', img: '/static/img/noorder.png' },
				{ id: 2, name: '唐服', img: '/static/img/noorder.png' },
				{ id: 3, name: '裤子', img: '/static/img/noorder.png' },
				{ id: 4, name: '伞', img: '/static/img/noorder.png' },
